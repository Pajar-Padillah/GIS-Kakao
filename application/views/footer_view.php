...
<footer class="main-footer">
  <div id="mycredit"><strong> Copyright &copy; <?php echo date('Y'); ?> Sistem Informasi Geografis Kebun Kakao Kab. Pesawaran
    </strong> <strong style="color: blue;">| Pajar Padillah |</strong> <strong>Politeknik Negeri Lampung</strong></a>
